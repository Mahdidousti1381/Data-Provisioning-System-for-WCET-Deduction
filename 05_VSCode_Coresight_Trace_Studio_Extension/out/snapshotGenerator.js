...
class SnapshotGenerator {
     ...
     */
    computeConfigRegister(enableCCI, enableTS) {
     ...
     */
    runSnapshotGeneration(params, onLog) {
        return new Promise((resolve) => {
            ...
            const proc = (0, child_process_1.spawn)(pythonExe, args, { cwd: this.workspaceRoot });
            let stdoutAccum = '';
            let stderrAccum = '';
     ...
     */
    applyCustomDeviceConfigs(snapDir, params, onLog) {
